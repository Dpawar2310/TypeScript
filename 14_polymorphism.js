...
var Manger = /** @class */ (function (_super) {
    ...
    Manger.prototype.Print = function () {
        _super.prototype.Print.call(this); //here is overriding his parent method "print()"
...
var MyName = /** @class */ (function (_super) {
    __extends(MyName, _super);
    function MyName(firstName, lastName, designation) {
    ...
    MyName.prototype.Print = function () {
        _super.prototype.Print.call(this);
        console.log(this.firstName, this.lastName, this.designation);
    };
    return MyName;
}(Employee));
var employees = new Array(new Manger("Jack", "Sparrow", "Manger"), new Lead("Sumit", "Pande", "Lead"), new Developer("Dnyanesh", "Surya", "Developer"), new MyName("Dipali", "Pawar", "Developer"));
